# BoneHitboxLib 26.1.2

[English](README.md) | [简体中文](README.zh-CN.md)

Version **0.2.0** for Minecraft **26.1.2**, supporting **Fabric / NeoForge**. This is an independent Gradle project. Use matching client, server and dependency versions from the [version guide](../README.md).
