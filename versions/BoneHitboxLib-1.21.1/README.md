...
Version **0.2.0** for Minecraft **1.21.1**, supporting **Fabric / NeoForge**. This is an independent Gradle project. Use matching client, server and dependency versions from the [version guide](../README.md).
