...
public final class BoneHitboxConfig {
    ...
    private static final ForgeConfigSpec.BooleanValue VANILLA_SLANTED_BLOCK_OBB;
    private static final ForgeConfigSpec.BooleanValue FORCE_ALL_BLOCK_OBB;
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> BLOCK_MODEL_WHITELIST;
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> BLOCK_MODEL_BLACKLIST;

    private static final ForgeConfigSpec.BooleanValue SHOW_CROSSHAIR_OBB;
    ...
    static {
        ...
        BLOCK_MODEL_WHITELIST = common.comment(
                ...
                .defineListAllowEmpty(List.of("blockModelWhitelist"), List::of, BoneHitboxConfig::validBlockFilter);
        BLOCK_MODEL_BLACKLIST = common.comment(
                ...
                .defineListAllowEmpty(List.of("blockModelBlacklist"), List::of, BoneHitboxConfig::validBlockFilter);
    ...
    private static List<? extends String> values(ForgeConfigSpec.ConfigValue<List<? extends String>> value) {
