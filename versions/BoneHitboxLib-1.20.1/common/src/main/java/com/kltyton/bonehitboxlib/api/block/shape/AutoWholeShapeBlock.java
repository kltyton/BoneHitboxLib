...
public abstract class AutoWholeShapeBlock extends AutoPartShapeBlock {
    protected AutoWholeShapeBlock(ResourceLocation blockId, Properties properties) {
        super(blockId, properties);
    }

    protected AutoWholeShapeBlock(ResourceLocation blockId, Properties properties, BlockShapeMode mode) {
