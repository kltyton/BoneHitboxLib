...
public class GeckoObbTestEntity extends PathfinderMob implements GeoEntity,
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        AnimationController<GeckoObbTestEntity> controller = new AnimationController<GeckoObbTestEntity>(this, "walk", 5, state -> state.setAndContinue(WALK))
                .setCustomInstructionKeyframeHandler(event -> {
                    bonehitboxlib$geoHandleInstruction(event.getKeyframeData().getInstructions());
