...
public final class ModelShapeProvider {
    ...
    public static VoxelShape union(List<Identifier> modelIds, BlockShapeMode mode) {
    ...
    public static VoxelShape shape(Identifier modelId, Direction facing, BlockShapeMode mode) {
        return mode.apply(ModelShapeCache.get(modelId, facing).wholeShape());
    }

    public static VoxelShape shape(Identifier modelId, BlockShapeMode mode) {
    ...
    public static void prepare(Identifier modelId) {
